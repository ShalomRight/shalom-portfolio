...
export const metadata: Metadata = {
  title: "Shalom.js — Brand · Motion · UI/UX · Web",
  description: "Portfolio of Shalom Sutherland — multidisciplinary designer based in Saint Vincent and the Grenadines, working across brand identity, motion, UI/UX, and front-end development.",
};
